...
public class ComidaData {
    ...
    public void borrarComida(int idComida) {
        ...
        String sql = "DELETE FROM comida WHERE idComida = " + idComida;
    ...
    public List<Comida> listaComida() {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                listaComidas.add(new Comida(rs.getString("nombre"), rs.getString("detalle"), rs.getInt("cantCalorias"), rs.getInt("idComida")));
